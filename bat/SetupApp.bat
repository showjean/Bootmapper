...
set CERT_NAME="BootmapperClient"
::set CERT_PASS=
set CERT_FILE="keystore\bootmapper_newcert.p12"
set SIGNING_OPTIONS=-storetype pkcs12 -keystore %CERT_FILE%

:: Application descriptor
set APP_XML=src\BootmapperClient-app.xml
...
:: Output
set AIR_PATH=bin-release
set AIR_NAME=BootmapperClient
